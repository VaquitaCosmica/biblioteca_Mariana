...
<html lang="es">
    ...
    <%
        ...
        System.out.println("ESTOY EN CREARmantenimiento.jsp, empleado: " + empleados.get(0).getNombre());
    %>
    <body  class="body" bgcolor="#e0766e">
        <form method="GET" action="MantenimientoServlet"  class="div_reg">
            <h1 class="login_title">Crear Mantenimiento</h1>
            <h3 class="login_text">ID</h3>
            <input type="text" name="id_manto" class="entrada" value="" placeholder="1706220829" required>

            <h3 class="login_text">Fecha mantenimiento</h3>
            <input type="date" name="f_manto" class="entrada" value="" required>

            <h3 class="login_text">Empleado</h3>
            <select type="text" name="ID_empleado" class="entrada" value="" required>
                <option value="" selected disabled>Seleccione el empleado que da el mantenimiento</option>
            ...
            <select type="text" name="id_mobiliario" class="entrada" value="" required>
                <option value="" selected disabled>Seleccione el mobiliario que esta en mantenimiento</option>
