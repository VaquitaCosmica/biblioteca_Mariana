        ...
        <div class="fondo">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="celda"> <%= libro.getId_libro()%>
                    </td>
                    <td class="celda"> <%= libro.getTitulo()%>
                    </td>
                    <td class="celda"><%= libro.getCategoria()%> 
                    </td>
                    <td class="celda"> <%= libro.getAnaquel()%>
                    </td>
                    <td class="celda"> <%= libro.getIdioma()%>
                    </td>
                    <td class="celda"> <%= libro.getPaginas()%>
                    </td>
                    <td class="celda"> <%= libro.getAutor()%>
                    </td>
                    <td class="celda"> <%= libro.getAño()%>
                    </td>
                    <td class="celda"><%= libro.getEditorial()%>
                    </td>
                    <td class="celda">                        
                        ...
                        <form method="GET" action="LibroServlet">
                            ...
                            <input type="hidden" name="categoria" value="<%= libro.getCategoria()%>" />
                            <input type="hidden" name="anaquel" value="<%= libro.getAnaquel()%>" />
                            <input type="hidden" name="idioma" value="<%= libro.getIdioma()%>" />
                            <input type="hidden" name="paginas" value="<%= libro.getPaginas()%>" />
                            <input type="hidden" name="autor" value="<%= libro.getAutor()%>" />
                            <input type="hidden" name="anio" value="<%= libro.getAño()%>" />
