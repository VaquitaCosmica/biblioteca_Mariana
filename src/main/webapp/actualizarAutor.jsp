...
<html lang="es">
    ...
    %>
    <body  method="GET" action="AutorServlet" class="body" bgcolor="#e0766e">
        <form class="div_reg">
            <h1 class="login_title">Editar Libro</h1>
            <h3 class="login_text">ID (seudónimos) </h3>
            <input type="text" name="id_autor" class="entrada" value="<%=autor.getId_Autor()%>" >
            <h3 class="login_text">Autor</h3>
            <input type="text" name="nombre" class="entrada" value="<%= autor.getNombre() %>">           
            <input type="hidden" name="antiguoId" value="<%=autor.getId_Autor()%>" >
